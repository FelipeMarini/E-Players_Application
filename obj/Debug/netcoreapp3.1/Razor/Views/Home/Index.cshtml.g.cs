#pragma checksum "C:\Users\Felipe\OneDrive\Área de Trabalho\E-Players_Application\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2a8ce271cd26fe78d65a378140b99eee1c5ae393"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2a8ce271cd26fe78d65a378140b99eee1c5ae393", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\Felipe\OneDrive\Área de Trabalho\E-Players_Application\Views\Home\Index.cshtml"
...
#nullable disable
            WriteLiteral("\r\n<div class=\"banner\">\r\n    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2a8ce271cd26fe78d65a378140b99eee1c5ae3934619", async() => {
...
<img src=""img/9a6e4f50b0d94f75ce274348f06a6d56.png"" alt=""Imagem de um 
...
<section id=""horarios"">
    ...
    <div class=""container"">
        <div class=""ao_vivo"">
            ...
            <div class=""partida"">
                <strong>SK</strong>
                <img src=""img/SK.png"" alt=""Logo da equipe SK"">
                <I>VS</I>
                <img src=""img/FLA.png"" alt=""Logo da equipe do Flamengo"">
                <strong>FLA</strong>
            </div>
        </div>

        <di");
            WriteLiteral(@"v class=""em_breve"">
            <h2>EM BREVE</h2>
            <div class=""partida"">
                <strong>SK</strong>
                <img src=""img/SK.png"" alt=""Logo da equipe SK"">
...
<div class=""container content"">
    <section");
            WriteLiteral(@" class=""noticias"">
        <div class=""card"">
            <img src=""img/Teams/T1.jpeg"" alt=""Notícia sobra assunto 1"">
            <div>
        ...
        <div class=""card"">
            <img src=""img/Teams/T2.jpg"" alt=""Notícia sobra assunto 1"">
            <div>
                <h4>Título da Noticia</h4>
                <p> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quos quibusdam quidem praesentium
                    velit vel sapiente nemo obcaecati veritatis dolorum odio facere, quisquam mollitia quo eum.
        ...
        <");
            ...
            <img src=""img/Teams/T3.jpeg"" alt=""Notícia sobre assunto 1"">
            <div>
                <h4>Título da Noticia</h4>
                <p> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quos quibusdam quidem praesentium
                    velit vel sapiente nemo obcaecati veritatis dolorum odio facere, quisquam mollitia quo eum.
        ...
        <div class=""card"">
            <img src=""img/Teams/T9.jpeg"" alt=""Notícia sobre assunto 1"">
            <div>
                <h4>Título da Noticia</h4>
                <p> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quos quibusdam quidem praesentium
                    velit vel sapiente nemo obcaecati veritatis dolorum odio facere, quisquam mollitia quo eum.
        ...
        <div class=""card"">
           ");
            WriteLiteral(@" <img src=""img/Teams/T5.jpeg"" alt=""Notícia sobre assunto 1"">
            <div>
                <h4>Título da Noticia</h4>
                <p> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quos quibusdam quidem praesentium
                    velit vel sapiente nemo obcaecati veritatis dolorum odio facere, quisquam mollitia quo eum.
        ...
        <div class=""card"">
            <img src=""img/Teams/T7.jpeg"" alt=""Notícia sobra assunto 1"">
            <div>
                <h4>Título da Noticia</h4>
                <p> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quos quibusdam quidem praesentium
                    velit vel sapiente nemo obcaecati veritatis dolorum odio facere, quisquam mollitia quo eum.
    ...
    <section class=""recentes"" id=""resultados"">
       ");
            WriteLiteral(@" <h3>PARTIDAS RECENTES</h3>
